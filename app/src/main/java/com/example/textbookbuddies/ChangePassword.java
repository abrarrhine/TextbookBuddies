        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
              if (task.isSuccessful()){
                  Toast.makeText(ChangePassword.this, "Check your email to reset password!", Toast.LENGTH_LONG).show();
                  Intent loginIntent = new Intent(ChangePassword.this, LoginActivity.class);
                  startActivity(loginIntent);
              }
              else {
                  Toast.makeText(ChangePassword.this, "Password reset was unsuccessful! Please Try again!", Toast.LENGTH_LONG).show();
              }
            }
        });
    }
